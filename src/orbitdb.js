...
import { DefaultLibp2pBrowserOptions } from "./config";
...
const startOrbitDB = async ({ id, identity, identities, directory } = {}) => {
  const options = DefaultLibp2pBrowserOptions;
...
export { startOrbitDB, stopOrbitDB, DefaultLibp2pBrowserOptions, isBrowser };
